...
//Arm Define
	...
	#define GRIPPER_SOLENOID_CLOSE 2
	#define GRIPPER_SOLENOID_OPEN 6

#define COMP_ROBOT
#ifdef COMP_ROBOT
	#define ARM_PIVOT_POSITION_TOP 1
	#define ARM_PIVOT_POSITION_BOT 95
	#define SHOULDER_TIPPED_OVER_CAN 84
	#define ARM_STEP_HEIGHT 76
	#define ARM_STEP_HEIGHT_EXTENDED 77
	#define FOUR_TOTE_HEIGHT 23	//TEST!!!
	#define SHOULDER_PRE_TIPPED_OVER_CAN 65
#else
	#define ARM_PIVOT_POSITION_TOP 1
	#define ARM_PIVOT_POSITION_BOT 95
	#define SHOULDER_PRE_TIPPED_OVER_CAN 65
	#define SHOULDER_TIPPED_OVER_CAN 83
	#define ARM_STEP_HEIGHT 78
	#define ARM_STEP_HEIGHT_EXTENDED 79
	#define FOUR_TOTE_HEIGHT 15
#endif
...
//FishingPole Define
	#define FISHING_POLE_SOLENOID_L 4
	#define FISHING_POLE_SOLENOID_R 5
	#define FISHING_POLE_SOLENOID_LENGTH 7
