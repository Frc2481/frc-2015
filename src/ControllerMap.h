...
#define GRIPPER_OPEN_BUTTON			new POVJoystickButton(auxStick, 0, XboxController::xbDPadRight)
#define GRIPPER_CLOSE_BUTTON		new POVJoystickButton(auxStick, 0, XboxController::xbDPadLeft)
